...
var control = document.querySelector('[data-tabs="control"]');
window.addEventListener('DOMContentLoaded', function () {
  (0, _playButton.addEvtVideo)();
  if (control) {
    (0, _initTabs.initTabs)();
    _initTabs.tabs.openTab(control);
  }
...
},{"./modules/form-validate/form":3,"./modules/play-button":9,"./modules/size-video":10,"./utils/ios-vh-fix":12,"./vendor/tabs/init-tabs":13}],2:[function(require,module,exports){
"use strict";
